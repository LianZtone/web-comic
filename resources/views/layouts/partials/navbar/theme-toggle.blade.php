<label class="swap swap-rotate" aria-label="Toggle dark mode">
    ...
    <svg class="swap-off h-5 w-5 fill-current" data-theme-icon-light xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24">
        <path
    ...
    <svg class="swap-on h-5 w-5 fill-current" data-theme-icon-dark xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24">
        <path
